 ...
 * @file package.h
 *
 * @brief Ce document est un template d'exemple d'un .h
 *
...
/**
 * @brief Fonction qui doit être testée.
 *
 *
 * @param [in] value la valeur à tester
 *
 * @retval 1 si value == 1
 * @retval 0 si value != 0
 */
...
extern int toBeTested(int value);
 ...
 union {
     int a; ///< ceci est un int qui sert à rien
     int b;
 };
